...
const JWM_LOCALES = {
  en: {
    ...
    checkUpdates: "Check for new versions (once a day, GitHub)",
    updateAvailable: "New version v{v} available — download",
  ...
  ko: {
    ...
    checkUpdates: "새 버전 확인 (하루 1회, GitHub)",
    updateAvailable: "새 버전 v{v} 사용 가능 — 다운로드",
  ...
  zh: {
    ...
    useHolidays: "包含法定节假日",
    coverBars: "同时覆盖任务条",
    checkUpdates: "检查新版本（每天一次，GitHub）",
    updateAvailable: "新版本 v{v} 可用 — 下载",
    customLegend: "自定义休息日",
  ...
  hi: {
    ...
    checkUpdates: "नया संस्करण जाँचें (दिन में एक बार, GitHub)",
    updateAvailable: "नया संस्करण v{v} उपलब्ध — डाउनलोड करें",
