...
const JWM_LOCALES = {
  en: {
    updated: "Updated to v{v} — see what's new",
    barsLegend: "Issue bars",
    showWorkdays: "Show working-day count in bars",
    dueWarning: "Deadline warning",
    dueWarnDays: "within {n} working days",
    colorsLegend: "Colors",
    ...
    dueOverdueTitle: "Overdue: due date {date} was {n} day(s) ago",
    dueSoonTitle: "Due soon: {date}, {n} working day(s) left",
    ...
    modeLegend: "Display",
    modeHighlight: "Highlight (colored)",
  ...
  ko: {
    updated: "v{v}로 업데이트됨 — 변경 내용 보기",
    barsLegend: "이슈 막대",
    showWorkdays: "막대에 근무일 수 표시",
    dueWarning: "마감 경고",
    dueWarnDays: "근무일 {n}일 이내",
    colorsLegend: "색상",
    ...
    dueOverdueTitle: "기한 초과: {date} 기한이 {n}일 지났습니다",
    dueSoonTitle: "마감 임박: 기한 {date}, 근무일 {n}일 남음",
    regionLegend: "국가 · 언어",
    _name: "한국어",
    title: "Jira Timeline Weekend Marker",
    country: "국가",
  ...
  zh: {
    ...
    dueOverdueTitle: "已逾期：截止日 {date}，已过 {n} 天",
    dueSoonTitle: "即将截止：{date}，剩余 {n} 个工作日",
    regionLegend: "国家与语言",
    _name: "中文",
    title: "Jira Timeline Weekend Marker",
    country: "国家/地区",
  ...
  hi: {
    updated: "v{v} में अपडेट किया गया — नया क्या है देखें",
    barsLegend: "इश्यू बार",
    showWorkdays: "बार में कार्यदिवसों की संख्या दिखाएँ",
    dueWarning: "समय-सीमा चेतावनी",
    dueWarnDays: "{n} कार्यदिवसों के भीतर",
    colorsLegend: "रंग",
    ...
    dueOverdueTitle: "समय-सीमा पार: नियत तिथि {date}, {n} दिन बीत चुके",
    dueSoonTitle: "समय-सीमा निकट: {date}, {n} कार्यदिवस शेष",
    ...
    modeLegend: "प्रदर्शन",
    modeHighlight: "हाइलाइट करें (रंगीन)",
